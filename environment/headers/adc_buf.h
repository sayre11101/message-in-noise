...
// --- RF & Modulation Specifications ---
#define SAMPLE_RATE (128 * 1024) // ADC Sampling Frequency in Hz
...
#define FSK_DEVIATION 0.90 // +/- 0.90 Hz shift for Mark/Space
...
#define MAX_LOOPS 5           // number of repeats of the message
